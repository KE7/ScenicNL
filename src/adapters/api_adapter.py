...
class Scenic3:
    ...
    def set_map(self, map_name:Any, indent:int=0):
    ...
    def do(self, behavior_name:Any, indent:int=0, **kwargs):
        indent_str = self._indent * indent
    ...
    def do_while(self, behavior_name:Any, var_name:Any, condition:Any, indent:int=0):
        indent_str = self._indent * indent
    ...
    def do_until(self, behavior_name:Any, var_name:Any, condition:Any, indent:int=0):
        indent_str = self._indent * indent
    ...
    def try_except(self, try_behavior, except_behavior, indent:int=0):
        indent_str = self._indent * indent
    ...
    def interrupt(self, condition:Any, indent:int=0, *args):
        indent_str = self._indent * indent
    ...
    def take(self, action_name:Any, indent:int=0, **params):
        indent_str = self._indent * indent
    ...
    def new(self, var_name:Any, obj_type:Any, at=None, indent:int=0, **kwargs):
        indent_str = self._indent * indent
    ...
    def spatial_relation(self, obj1:Any, keyword:Any, obj2:Any, distance=None, indent:int=0):
        indent_str = self._indent * indent
